...
| 2-3   | 5m         |ssh,ls,cat     | 30/03/24 |    Easy    | cat 'File name', for showing the output of a file which have spaces in it's file name, after cat command we have to mention the file name(with spaces given in it) inside a single quote('').